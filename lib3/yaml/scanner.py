...
class Scanner:
            ...
            if ch in '0123456789':
                ...
                if increment == 0:
                    raise ScannerError(
                        ...
                        "expected indentation indicator in "
                        "the range 1-9, but found 0",
                        self.get_mark())
                self.forward()
    ...
    def scan_uri_escapes(self, name, start_mark):
            ...
            for k in range(2):
                if self.peek(k) not in '0123456789ABCDEFabcdef':
                    raise ScannerError(
                        ...
                        "hexdecimal numbers, but found %r"
        ...
        try:
            ...
            raise ScannerError("while scanning a %s"
                               % name, start_mark, str(exc), mark)
        return value
